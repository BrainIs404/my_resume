	...
	\resumeSubheading
       ...
       \resumeItemListStart
		\resumeItem{Worked on the software/firmware for an infrared imaging instrument}
          \resumeItem{Improved project code quality by doing refactor of large partial classes}
          \resumeItem{Expanded project unit test suite to ensure the project meets the quality of industry standards}

...
\section{Experience}
  \resumeSubHeadingListStart
	...
	\resumeSubheading
       ...
       {Agilent Technologies $|$ \emph{C\#, WPF, .Net Frameworks,  MSTest, Moq}}{Melbourne, Australia}
       \resumeItemListStart
	\resumeItem{Expanded the functionality and maintained the quality for the software of an infrared imaging instrument}
	\resumeItem{Collaborated with a team to ensure the project meets the stakeholders deadline and expectation}
        \resumeItem{Implemented a different scan method to match a new type of sample filter}
...
\section{Technical Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     ...
     \textbf{Frameworks}{: WPF, Bootstrap, JQuery, Node.js, Express.js, MongoDB, SMART on FHIR} \\
     \textbf{Unit test frameworks}{: JUnit, MSTests, Moq, Microsoft Fakes} \\
